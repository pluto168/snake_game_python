...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("DiDi And Apple Game")
    ...
    def play_sound(self,sound_name):
        if sound_name == "crash":
            ...
            sound = pygame.mixer.Sound("resources/dog.mp3")
    ...
    def show_game_over(self):
        self.render_background()
        font = pygame.font.SysFont('arial',30)
        line1 = font.render(f"GG! your score is {self.snake.length}",True,(255,255,255))
